...
int main()
{
    ...
    PermissionsProxy permissions_proxy(*connection, permissionsServiceName, permissionsObjectPath);
    try
    {
    ...
    {
        if (e.getName() == sdbus::Error::Name("com.system.time.UnauthorizedAccess"))
        {
