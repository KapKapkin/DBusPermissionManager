...
protected:
    ...
    {
        m_object.addVTable(sdbus::registerMethod("GetSystemTime").withOutputParamNames("permissionEnumCode").implementedAs([this](){ return this->GetSystemTime(); })).forInterface(INTERFACE_NAME);
    }
